...
var LANG_TRANSLATIONS = {
  ja: {
    ...
    shop_unavailable_now:  "現在購入できません",
    shop_stock_fetch_failed: "在庫を確認できませんでした。しばらくしてから再度お試しください。",
    shop_retry:            "再試行",
    shop_stock_check_failed_list: "在庫を確認できません",
  ...
  en: {
    ...
    renewal_title:  "New Store Opening",
    renewal_date:   "Opening Saturday, May 2, 2026",
    renewal_desc:   "Fukameki Zakka-ten will relocate and reopen as \"ARC FUKAMEKI minoh\" on Saturday, May 2, 2026. Located just one minute's walk from the previous store, we look forward to welcoming you in our new space.",
    ...
    shop_unavailable_now:  "Currently unavailable",
    shop_stock_fetch_failed: "Could not check stock. Please try again later.",
    shop_retry:            "Retry",
    shop_stock_check_failed_list: "Stock unavailable",
  ...
  zh: {
    ...
    renewal_desc:   "深目杂货店将于2026年5月2日（周六）以「ARC FUKAMEKI minoh」之名迁至新店重新开业。新店位于原店步行1分钟处，期待在全新的空间里迎接各位顾客。",
    renewal_btn:    "查看详情",
    news_title:     "最新消息",
    ex_label:       "展览",
    ex_title:       "企划展",
    ...
    shop_unavailable_now:  "目前无法购买",
    shop_stock_fetch_failed: "无法确认库存，请稍后再试。",
    shop_retry:            "重试",
    shop_stock_check_failed_list: "无法确认库存",
